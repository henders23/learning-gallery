...
// Clean hub-and-spoke: a central circular rotunda with 8 labelled doorways,
// each opening to a colour-coded themed wing. Artworks are auto-distributed
// along the walls by world.js, so per-theory wall/t fields are advisory only.
...
const ROOMS = {
  atrium: {
    ...
    wall:  "#dccdb2",
    accent: "#8a6d44",
    guide: "Start here. Eight labelled doorways ring the rotunda, one per theme — read the signs to choose a wing. The pictures here cover the big-picture meta-frameworks, the teacher's stance, and a few hotly contested ideas worth approaching with care.",
  ...
  design: {
    ...
    wall:  "#d39a6f",
    accent: "#a8551f",
    guide: "How to deliberately design instruction. Look for the contrast between systematic, step-by-step models (ADDIE, Gagné, Merrill) and behaviourist roots — and notice how technology-based frameworks try to update them for screens and software.",
    doors: ["W"],
  },
  cog: {
    name: "Cognition Wing",
    ...
    wall:  "#a78fc2",
    accent: "#6a4f99",
    guide: "How the mind processes information. Pay attention to working-memory limits and cognitive load — the through-line that ties these pictures together — and how schema and dual-coding ideas build on that foundation.",
    doors: ["W"],
  },
  mem: {
    name: "Memory Wing",
    ...
    wall:  "#79bdb0",
    accent: "#1f7d6d",
    guide: "How memory is made durable. Look for the evidence-backed strategies — spacing, retrieval practice, interleaving — and contrast them with the popular myths (learning styles, re-reading) that feel effective but aren't.",
    doors: ["W"],
  },
  mot: {
    name: "Motivation Wing",
    ...
    wall:  "#aac279",
    accent: "#5f7d28",
    guide: "What drives learners to start, persist and self-direct. Pay attention to the difference between intrinsic and extrinsic motivation, and how self-regulation frameworks turn motivation into a teachable set of habits.",
    doors: ["W"],
  },
  soc: {
    name: "Social Wing",
    ...
    wall:  "#88a8ce",
    accent: "#33639c",
    guide: "Learning as a social, situated act. Look for how knowledge is built with others and inside communities of practice — and how constructivist ideas reframe the learner as an active maker of meaning rather than a receiver.",
    doors: ["W"],
  },
  adu: {
    name: "Adult Learning Wing",
    ...
    wall:  "#cf93a1",
    accent: "#a23e55",
    guide: "How adults learn differently. Pay attention to the role of prior experience, self-direction and immediate relevance — and how experiential cycles turn doing-then-reflecting into a deliberate method.",
    doors: ["W"],
  },
  eap: {
    name: "EAP Wing",
    ...
    wall:  "#9890c6",
    accent: "#494099",
    guide: "Frameworks specific to English for Academic Purposes. Look for genre, discourse and academic-literacies lenses — how they treat writing as situated social practice rather than a neutral set of skills.",
    doors: ["W"],
  },
  tax: {
    name: "Taxonomy Wing",
    ...
    wall:  "#d8bd72",
    accent: "#b08820",
    guide: "How learning is classified and how it transfers. Pay attention to the ladders of complexity (Bloom, SOLO) and to the hard problem of transfer — why skills learned in one place so often fail to show up in another.",
    doors: ["W"],
  },
};
